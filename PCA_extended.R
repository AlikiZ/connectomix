...
## Firstly, let us set a variable for the column containing the grouping so as to exclude this column from the analysis
colgroup = 75
## Category sub1:
print("analyze aggregated group sub1")
